...
namespace Domain.Migrations
{
    ...
    [Migration("20170510152257_M2M Route")]
    partial class M2MRoute
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Domain.Entities.RailwayStations.RailwayStationDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Domain.Entities.RailwayStations.RailwayStStationStations", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.StationsRouteDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("StationDtoId");

                    b.HasKey("Id");

                    b.HasIndex("StationDtoId");

                    b.ToTable("StationsRoute");
                });

            modelBuilder.Entity("Domain.Entities.RailwayStations.RailwayStStationStations", b =>
                {
                    b.HasOne("Domain.Entities.RailwayStations.RailwayStationDto", "RailwayStationDto")
                        .WithMany("Stations")
            ...
            modelBuilder.Entity("Domain.Entities.StationsRouteDto", b =>
                {
                    b.HasOne("Domain.Entities.StationDto", "StationDto")
                        .WithMany("StationsRouteDto")
                        .HasForeignKey("StationDtoId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
        }
    }
